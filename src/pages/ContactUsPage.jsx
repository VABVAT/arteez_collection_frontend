  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-4">
        ...
        <p>
          You can chat with us on WhatsApp at <a href="https://wa.me/7009751782" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">+91 7009751782</a>.
        </p>
        <p>
